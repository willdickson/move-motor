...
// ------------------------------------------------------------------
int
outscan_kine (kine_t kine, motors_t motors, int dt_ns, int *end_pos)
{
  int i, j;
...
// ----------------------------------------------------------------
int
get_kine_pos (kine_t * kine, int motor_n, int index, int *pos)
{
  int s0, s1;
  int *ptr;
...
// -----------------------------------------------------------------
void
print_err_msg (char *file, int line, char *err_msg)
{
